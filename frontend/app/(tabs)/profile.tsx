      ...
      >
        <View style={[styles.header, { paddingTop: insets.top + spacing.lg }]}>
          ...
          <View style={styles.accountCard}>
            ...
            <View style={{ flex: 1 }}>
              <Display weight="medium" style={styles.accountNameLg} numberOfLines={1}>
                {isGuest ? "Guest" : (user?.name || "Your account")}
              </Display>
              ...
              <View style={premium ? styles.badgePremium : styles.badgeFree}>
                ...
                <Txt style={premium ? styles.badgePremiumTxt : styles.badgeFreeTxt}>
                  {premium ? "Premium" : isGuest ? "Guest mode" : "Free plan"}
                </Txt>
              </View>
            </View>
            {!isGuest && (
        ...
        <View style={styles.body}>
          {isGuest && (
            <Pressable style={styles.guestCard} testID="guest-backup-cta" onPress={login} disabled={signingIn}>
              ...
              {signingIn ? <ActivityIndicator color={colors.sage} /> : <Feather name="chevron-right" size={18} color={colors.sage} />}
            </Pressable>
          )}
          ...
          {/* Calendar is intentionally hidden for launch until OAuth is reliable. */}

          <Pressable
            style={premium ? styles.premiumActiveCta : styles.premiumUpsell}
          ...
          <Pressable
            ...
            testID="open-health-report"
            onPress={() => (premium ? router.push("/health-report") : router.push("/premium"))}
          >
            ...
            {!premium
              ? <Feather name="lock" size={16} color={colors.onSurfaceTertiary} />
              : <Feather name="chevron-right" size={20} color={colors.onSurfaceTertiary} />}
          </Pressable>
          ...
          >
            ...
            <Display weight="medium" style={styles.missingTitle}>Buy smarter, not more</Display>
              ...
              <View style={styles.confirmCard}>
                ...
                <Pressable style={styles.confirmDeleteBtn} testID="confirm-delete" onPress={handleDelete} disabled={deleting}>
                  {deleting
                    ...
                    : <Txt style={styles.confirmDeleteTxt}>Delete everything</Txt>}
                </Pressable>
      ...
      {items.map((it, i) => (
        <Pressable key={it.id} style={styles.rankRow} onPress={() => router.push(`/item/${it.id}`)}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Txt style={styles.rankMeta}>{it.wear_count} {it.wear_count === 1 ? "wear" : "wears"}</Txt>
          </View>
        </Pressable>
      ))}
    </View>
...
const styles = StyleSheet.create({
  ...
  guestCard: { flexDirection: "row", alignItems: "center", gap: spacing.md, backgroundColor: colors.brandTertiary, borderRadius: radius.md, padding: spacing.lg, marginBottom: spacing.xl },
  guestIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.sage, alignItems: "center", justifyContent: "center" },
  ...
  reportCta: { flexDirection: "row", alignItems: "center", gap: spacing.md, marginTop: spacing.xl, borderWidth: 0.5, borderColor: colors.borderStrong, borderRadius: radius.md, padding: spacing.lg },
